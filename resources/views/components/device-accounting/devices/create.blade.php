...
<x-modal id="create-modal" class="modal-lg modal-fullscreen-lg-down">
    ...
    <div class="d-flex align-items-start">
        ...
        <form id="store-device-form" action="{{ route(devices.store) }}" method="post">
    ...
    <div role="tabswitcherlist" class="d-flex mt-auto justify-content-end">
        ...
        <x-button form="store-device-form" role="tabswitcher" direction="finish" id="store-device-btn" class="ms-2" disabled>{{ __('dialog.actions.finish') }}</x-button>
    </div>
